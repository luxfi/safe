...
export interface Gnosis_safeInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "SENTINEL_MODULES",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "SENTINEL_OWNERS",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "SAFE_MSG_TYPEHASH",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "SAFE_TX_TYPEHASH",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Gnosis_safe extends BaseContract {
  ...
  functions: {
    ...
    changeMasterCopy(
      _masterCopy: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
